    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end relative z-[30]">
            <a wire:navigate href="/cart">
                <img class="pr-6 {{ Request::is('login', 'register', 'store', 'profile', 'cart', 'menu') ? 'filter invert' : '' }} 
               hover:brightness-[50%]"
                    src="{{ asset('images/cart-navbar.svg') }}" alt="Logo Cart Navbar">
            </a>
            <span
                class="{{ Request::is('login', 'register', 'store', 'profile', 'cart', 'menu') ? 'filter invert' : '' }} px-1 rounded-full w-[1.5vw] ml-[-2vw] mr-[1vw] text-center text-lg font-medium text-white flex items-center justify-center">4</span>
            <a wire:navigate href="{{ route('profile.redirect') }}">
                <img class="{{ Request::is('login', 'register', 'store', 'profile', 'cart', 'menu') ? 'filter invert' : '' }} 
               hover:brightness-[50%]"
